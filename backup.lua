...
-- window resize
-- WARNING: does not work with VimWiki
...
-- AutoFormat on save for python files
...
require("lazy").setup({
	...
	},
	{
		...
		opts = { signs = false },
		keys = {
			{ "<leader>XX", "<cmd>TodoTelescope<cr>" },
		},
	},
	{
		"folke/zen-mode.nvim",
		config = function()
			...
			vim.keymap.set("n", "zz", "<CMD>ZenMode<CR>", { desc = "Toggle ZenMode" })
		end,
	},
	{ "vimwiki/vimwiki" },
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<Leader>oi", vim.diagnostic.open_float, "Open Information")
